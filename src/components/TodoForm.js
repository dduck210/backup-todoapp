...
const TodoForm = ({ onAdd, users = [], isAdmin, currentUserId }) => {
  ...
  return (
    ...
    >
      ...
      {isAdmin && (
        <select
          className="h-12 px-4 py-2 bg-white dark:bg-gray-800 border border-blue-300 dark:border-gray-600 rounded-lg text-base text-gray-900 dark:text-gray-100 shadow-sm focus:outline-none focus:border-blue-500 dark:focus:border-gray-400 transition-all w-full sm:w-40 md:w-48 lg:w-56"
          value={assignedUser}
